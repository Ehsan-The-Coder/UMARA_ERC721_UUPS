...
<li><a href="_truffle_codec.Wrap.IntegerOrEnumValue.html">IntegerOrEnumValue</a></li></ul>
<h1>Type alias IntegerOrEnumValue</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Integer<wbr/>Or<wbr/>Enum<wbr/>Value</span><span class="tsd-signature-symbol">:</span> <a href="_truffle_codec.Wrap.IntegerValue.html" class="tsd-signature-type tsd-kind-type-alias">IntegerValue</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.Format.Values.EnumValue.html" class="tsd-signature-type tsd-kind-interface">EnumValue</a></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/types.ts#L107">codec/lib/wrap/types.ts:107</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Wrap.IntegerOrEnumValue.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Integer<wbr/>Or<wbr/>Enum<wbr/>Value</span></a></li>
