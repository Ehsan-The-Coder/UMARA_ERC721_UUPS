...
<li><a href="_truffle_codec.ReturndataDecoding.html">ReturndataDecoding</a></li></ul>
<h1>Type alias ReturndataDecoding</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Returndata<wbr/>Decoding</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/_truffle_codec.ReturnDecoding.html" class="tsd-signature-type tsd-kind-interface">ReturnDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.RawReturnDecoding.html" class="tsd-signature-type tsd-kind-interface">RawReturnDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.BytecodeDecoding.html" class="tsd-signature-type tsd-kind-interface">BytecodeDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.UnknownBytecodeDecoding.html" class="tsd-signature-type tsd-kind-interface">UnknownBytecodeDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.SelfDestructDecoding.html" class="tsd-signature-type tsd-kind-interface">SelfDestructDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.RevertMessageDecoding.html" class="tsd-signature-type tsd-kind-interface">RevertMessageDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.EmptyFailureDecoding.html" class="tsd-signature-type tsd-kind-interface">EmptyFailureDecoding</a></div>
<div class="tsd-comment tsd-typography"><p>A type representing a returndata (return value or revert message) decoding.
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/types.ts#L34">codec/lib/types.ts:34</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.ReturndataDecoding.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Returndata<wbr/>Decoding</span></a></li>
