...
<li><a href="_truffle_codec.LogDecoding.html">LogDecoding</a></li></ul>
<h1>Type alias LogDecoding</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Log<wbr/>Decoding</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/_truffle_codec.EventDecoding.html" class="tsd-signature-type tsd-kind-interface">EventDecoding</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_truffle_codec.AnonymousDecoding.html" class="tsd-signature-type tsd-kind-interface">AnonymousDecoding</a></div>
<div class="tsd-comment tsd-typography"><p>A type representing a log (event) decoding.  As you can see, these come in two types, each of which
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/types.ts#L26">codec/lib/types.ts:26</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.LogDecoding.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Log<wbr/>Decoding</span></a></li>
