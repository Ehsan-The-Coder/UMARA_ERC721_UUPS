<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>Case | Truffle Decoding and Encoding</title><meta name="description" content="Documentation for Truffle Decoding and Encoding"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="_truffle_codec.Wrap.Case.html">Case</a></li></ul>
<h1>Type alias Case&lt;TypeType, ValueType, RequestType&gt;</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Case</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">TypeType</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">ValueType</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">RequestType</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">dataType</span>, <span class="tsd-kind-parameter">input</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Generator</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">RequestType</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">ValueType</span><span class="tsd-signature-symbol">, </span><a href="_truffle_codec.WrapResponse.html" class="tsd-signature-type tsd-kind-type-alias">WrapResponse</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span></div>
<section class="tsd-panel">
<h4>Type Parameters</h4>
<ul class="tsd-type-parameter-list">
<li>
<h4><span class="tsd-kind-type-parameter">TypeType</span></h4></li>
<li>
<h4><span class="tsd-kind-type-parameter">ValueType</span></h4></li>
<li>
<h4><span class="tsd-kind-type-parameter">RequestType</span></h4></li></ul></section>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures">
<li class="tsd-signature" id="__type.__type-1"><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">dataType</span>, <span class="tsd-kind-parameter">input</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Generator</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">RequestType</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">ValueType</span><span class="tsd-signature-symbol">, </span><a href="_truffle_codec.WrapResponse.html" class="tsd-signature-type tsd-kind-type-alias">WrapResponse</a><span class="tsd-signature-symbol">&gt;</span></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">dataType</span>: <span class="tsd-signature-type tsd-kind-type-parameter">TypeType</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">input</span>: <span class="tsd-signature-type">unknown</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">options</span>: <a href="../interfaces/_truffle_codec.Wrap.WrapOptions.html" class="tsd-signature-type tsd-kind-interface">WrapOptions</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Generator</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">RequestType</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">ValueType</span><span class="tsd-signature-symbol">, </span><a href="_truffle_codec.WrapResponse.html" class="tsd-signature-type tsd-kind-type-alias">WrapResponse</a><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></li></ul></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/types.ts#L57">codec/lib/wrap/types.ts:57</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Wrap.AddressLikeType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-4194304"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-type-alias)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.31 16V8.224H8.91V7.24H14.79V8.224H12.39V16H11.31Z" fill="var(--color-text)"></path></g></svg><span>Address<wbr/>Like<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.AddressLikeValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Address<wbr/>Like<wbr/>Value</span></a></li>
<li><a href="_truffle_codec.Wrap.Case.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Case</span></a></li>
<li><a href="_truffle_codec.Wrap.DecimalType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Decimal<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.DecimalValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Decimal<wbr/>Value</span></a></li>
<li><a href="_truffle_codec.Wrap.IntegerOrEnumType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Integer<wbr/>Or<wbr/>Enum<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.IntegerOrEnumValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Integer<wbr/>Or<wbr/>Enum<wbr/>Value</span></a></li>
<li><a href="_truffle_codec.Wrap.IntegerType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Integer<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.IntegerValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Integer<wbr/>Value</span></a></li>
<li><a href="_truffle_codec.Wrap.NumericType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Numeric<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.TupleLikeType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Tuple<wbr/>Like<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Wrap.TupleLikeValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Tuple<wbr/>Like<wbr/>Value</span></a></li>
