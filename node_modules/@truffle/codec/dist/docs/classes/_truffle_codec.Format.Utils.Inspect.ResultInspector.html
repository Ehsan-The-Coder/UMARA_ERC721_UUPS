...
<li><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html">ResultInspector</a></li></ul>
<h1>Class ResultInspector</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>This class is meant to be used with Node&#39;s
<a href="https://nodejs.org/api/util.html#util_util_inspect_object_options">util.inspect()</a>
function.  Given a [[Format.Values.Result]] <code>value</code>, one can use
...
<h4>Example</h4><p>Suppose <code>value</code> is a Result.  In Node, the following would print to the
...
<li><span class="target">ResultInspector</span></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L70">codec/lib/format/utils/inspect.ts:70</a></li></ul></aside>
...
<div class="tsd-index-list"><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html#constructor" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-512"><rect fill="var(--color-icon-background)" stroke="#4D7FFF" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)"></path></g></svg><span>constructor</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Properties</h3>
<div class="tsd-index-list"><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html#options" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-1024"><rect fill="var(--color-icon-background)" stroke="#FF984D" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M9.354 16V7.24H12.174C12.99 7.24 13.638 7.476 14.118 7.948C14.606 8.412 14.85 9.036 14.85 9.82C14.85 10.604 14.606 11.232 14.118 11.704C13.638 12.168 12.99 12.4 12.174 12.4H10.434V16H9.354ZM10.434 11.428H12.174C12.646 11.428 13.022 11.284 13.302 10.996C13.59 10.7 13.734 10.308 13.734 9.82C13.734 9.324 13.59 8.932 13.302 8.644C13.022 8.356 12.646 8.212 12.174 8.212H10.434V11.428Z" fill="var(--color-text)"></path></g></svg><span>options</span></a>
<a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html#result" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>result</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Methods</h3>
<div class="tsd-index-list"><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html#_custom_" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-2048"><rect fill="var(--color-icon-background)" stroke="#FF4DB8" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M9.162 16V7.24H10.578L11.514 10.072C11.602 10.328 11.674 10.584 11.73 10.84C11.794 11.088 11.842 11.28 11.874 11.416C11.906 11.28 11.954 11.088 12.018 10.84C12.082 10.584 12.154 10.324 12.234 10.06L13.122 7.24H14.538V16H13.482V12.82C13.482 12.468 13.49 12.068 13.506 11.62C13.53 11.172 13.558 10.716 13.59 10.252C13.622 9.78 13.654 9.332 13.686 8.908C13.726 8.476 13.762 8.1 13.794 7.78L12.366 12.16H11.334L9.894 7.78C9.934 8.092 9.97 8.456 10.002 8.872C10.042 9.28 10.078 9.716 10.11 10.18C10.142 10.636 10.166 11.092 10.182 11.548C10.206 12.004 10.218 12.428 10.218 12.82V16H9.162Z" fill="var(--color-text)"></path></g></svg><span>[custom]</span></a>
<a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html#inspect" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>inspect</span></a>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_ResultInspector"><span class="tsd-kind-constructor-signature">new <wbr/>Result<wbr/>Inspector</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">result</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html" class="tsd-signature-type tsd-kind-class">ResultInspector</a><a href="#constructor.new_ResultInspector" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">result</span>: <a href="../types/_truffle_codec.Format.Values.Result.html" class="tsd-signature-type tsd-kind-type-alias">Result</a></h5></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">options</span>: <a href="../interfaces/_truffle_codec.Format.Utils.Inspect.ResultInspectorOptions.html" class="tsd-signature-type tsd-kind-interface">ResultInspectorOptions</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html" class="tsd-signature-type tsd-kind-class">ResultInspector</a></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L73">codec/lib/format/utils/inspect.ts:73</a></li></ul></aside></li></ul></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Properties</h2>
...
<div class="tsd-signature"><span class="tsd-kind-property">options</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/_truffle_codec.Format.Utils.Inspect.ResultInspectorOptions.html" class="tsd-signature-type tsd-kind-interface">ResultInspectorOptions</a></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L72">codec/lib/format/utils/inspect.ts:72</a></li></ul></aside></section>
<section class="tsd-panel tsd-member"><a id="result" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>result</span><a href="#result" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">result</span><span class="tsd-signature-symbol">:</span> <a href="../types/_truffle_codec.Format.Values.Result.html" class="tsd-signature-type tsd-kind-type-alias">Result</a></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L71">codec/lib/format/utils/inspect.ts:71</a></li></ul></aside></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Methods</h2>
<section class="tsd-panel tsd-member"><a id="_custom_" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>[custom]</span><a href="#_custom_" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="_custom_._custom_-1"><span class="tsd-kind-call-signature">[custom]</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">depth</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><a href="#_custom_._custom_-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">depth</span>: <span class="tsd-signature-type">number</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">options</span>: <a href="../interfaces/_truffle_codec.Format.Utils.Inspect.InspectOptions.html" class="tsd-signature-type tsd-kind-interface">InspectOptions</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L84">codec/lib/format/utils/inspect.ts:84</a></li></ul></aside></li></ul></section>
<section class="tsd-panel tsd-member"><a id="inspect" class="tsd-anchor"></a>
...
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="inspect.inspect-1"><span class="tsd-kind-call-signature">inspect</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">depth</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><a href="#inspect.inspect-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
...
<div class="tsd-comment tsd-typography">
<h4>Dev</h4><p>non-standard alternative interface name used by browser-util-inspect
     package</p>
</div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/format/utils/inspect.ts#L81">codec/lib/format/utils/inspect.ts:81</a></li></ul></aside></li></ul></section></section></div>
...
<li><a href="#result" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>result</span></a></li>
<li><a href="#_custom_" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>[custom]</span></a></li>
<li><a href="#inspect" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>inspect</span></a></li></ul></div></details></div>
<div class="site-menu">
...
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Format.Utils.Inspect.ResultInspector.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-128"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-class)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)"></path></g></svg><span>Result<wbr/>Inspector</span></a></li>
<li><a href="../interfaces/_truffle_codec.Format.Utils.Inspect.InspectOptions.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-256"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)"></path></g></svg><span>Inspect<wbr/>Options</span></a></li>
<li><a href="../interfaces/_truffle_codec.Format.Utils.Inspect.ResultInspectorOptions.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Result<wbr/>Inspector<wbr/>Options</span></a></li>
...
<li><a href="_truffle_codec.NoProjectInfoError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>No<wbr/>Project<wbr/>Info<wbr/>Error</span></a></li>
<li><a href="_truffle_codec.RepeatCompilationIdError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Repeat<wbr/>Compilation<wbr/>Id<wbr/>Error</span></a></li>
<li><a href="_truffle_codec.UnknownUserDefinedTypeError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Unknown<wbr/>User<wbr/>Defined<wbr/>Type<wbr/>Error</span></a></li>
