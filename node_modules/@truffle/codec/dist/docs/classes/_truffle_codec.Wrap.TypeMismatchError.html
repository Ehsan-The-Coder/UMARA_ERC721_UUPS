...
<li><a href="_truffle_codec.Wrap.TypeMismatchError.html">TypeMismatchError</a></li></ul>
<h1>Class TypeMismatchError</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>This error indicates that the given input could not be recognized as the
...
<ul class="tsd-hierarchy">
<li><span class="target">TypeMismatchError</span></li></ul></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L52">codec/lib/wrap/errors.ts:52</a></li></ul></aside>
...
<div class="tsd-index-list"><a href="_truffle_codec.Wrap.TypeMismatchError.html#constructor" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-512"><rect fill="var(--color-icon-background)" stroke="#4D7FFF" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)"></path></g></svg><span>constructor</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Properties</h3>
<div class="tsd-index-list"><a href="_truffle_codec.Wrap.TypeMismatchError.html#dataType" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-1024"><rect fill="var(--color-icon-background)" stroke="#FF984D" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M9.354 16V7.24H12.174C12.99 7.24 13.638 7.476 14.118 7.948C14.606 8.412 14.85 9.036 14.85 9.82C14.85 10.604 14.606 11.232 14.118 11.704C13.638 12.168 12.99 12.4 12.174 12.4H10.434V16H9.354ZM10.434 11.428H12.174C12.646 11.428 13.022 11.284 13.302 10.996C13.59 10.7 13.734 10.308 13.734 9.82C13.734 9.324 13.59 8.932 13.302 8.644C13.022 8.356 12.646 8.212 12.174 8.212H10.434V11.428Z" fill="var(--color-text)"></path></g></svg><span>data<wbr/>Type</span></a>
<a href="_truffle_codec.Wrap.TypeMismatchError.html#input" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>input</span></a>
<a href="_truffle_codec.Wrap.TypeMismatchError.html#reason" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>reason</span></a>
<a href="_truffle_codec.Wrap.TypeMismatchError.html#specificity" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>specificity</span></a>
<a href="_truffle_codec.Wrap.TypeMismatchError.html#variableName" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>variable<wbr/>Name</span></a>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_TypeMismatchError"><span class="tsd-kind-constructor-signature">new <wbr/>Type<wbr/>Mismatch<wbr/>Error</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">dataType</span>, <span class="tsd-kind-parameter">input</span>, <span class="tsd-kind-parameter">variableName</span>, <span class="tsd-kind-parameter">specificity</span>, <span class="tsd-kind-parameter">reason</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_truffle_codec.Wrap.TypeMismatchError.html" class="tsd-signature-type tsd-kind-class">TypeMismatchError</a><a href="#constructor.new_TypeMismatchError" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
...
<li>
<h5><span class="tsd-kind-parameter">input</span>: <span class="tsd-signature-type">any</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">variableName</span>: <span class="tsd-signature-type">string</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">specificity</span>: <span class="tsd-signature-type">number</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">reason</span>: <span class="tsd-signature-type">string</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="_truffle_codec.Wrap.TypeMismatchError.html" class="tsd-signature-type tsd-kind-class">TypeMismatchError</a></h4><aside class="tsd-sources">
<p>Overrides Error.constructor</p>
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L77">codec/lib/wrap/errors.ts:77</a></li></ul></aside></li></ul></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Properties</h2>
<section class="tsd-panel tsd-member"><a id="dataType" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>data<wbr/>Type</span><a href="#dataType" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">data<wbr/>Type</span><span class="tsd-signature-symbol">:</span> <a href="../types/_truffle_codec.Format.Types.Type.html" class="tsd-signature-type tsd-kind-type-alias">Type</a></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L55">codec/lib/wrap/errors.ts:55</a></li></ul></aside></section>
...
<div class="tsd-signature"><span class="tsd-kind-property">input</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L56">codec/lib/wrap/errors.ts:56</a></li></ul></aside></section>
<section class="tsd-panel tsd-member"><a id="reason" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>reason</span><a href="#reason" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">reason</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L54">codec/lib/wrap/errors.ts:54</a></li></ul></aside></section>
<section class="tsd-panel tsd-member"><a id="specificity" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>specificity</span><a href="#specificity" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">specificity</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
<div class="tsd-comment tsd-typography"><p>Specificity is used to determine which error to display;
the error with the highest specificity will be used.</p>
<p>Specificity 0: Only for use by the dispatcher</p>
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L75">codec/lib/wrap/errors.ts:75</a></li></ul></aside></section>
<section class="tsd-panel tsd-member"><a id="variableName" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>variable<wbr/>Name</span><a href="#variableName" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">variable<wbr/>Name</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/errors.ts#L53">codec/lib/wrap/errors.ts:53</a></li></ul></aside></section></section></div>
...
<li><a href="#specificity" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>specificity</span></a></li>
<li><a href="#variableName" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>variable<wbr/>Name</span></a></li></ul></div></details></div>
<div class="site-menu">
...
<li><a href="_truffle_codec.Wrap.BadResponseTypeError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-128"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-class)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)"></path></g></svg><span>Bad<wbr/>Response<wbr/>Type<wbr/>Error</span></a></li>
<li><a href="_truffle_codec.Wrap.NoOverloadsMatchedError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>No<wbr/>Overloads<wbr/>Matched<wbr/>Error</span></a></li>
<li><a href="_truffle_codec.Wrap.NoUniqueBestOverloadError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>No<wbr/>Unique<wbr/>Best<wbr/>Overload<wbr/>Error</span></a></li>
<li><a href="_truffle_codec.Wrap.TypeMismatchError.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Type<wbr/>Mismatch<wbr/>Error</span></a></li>
