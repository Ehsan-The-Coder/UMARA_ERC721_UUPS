...
<li><a href="../modules/_truffle_codec.Topic.Encode.html">Encode</a></li>
<li><a href="_truffle_codec.Topic.Encode.encodeTopic.html">encodeTopic</a></li></ul>
<h1>Function encodeTopic</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="encodeTopic"><span class="tsd-kind-call-signature">encode<wbr/>Topic</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">input</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Uint8Array</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">undefined</span><a href="#encodeTopic" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Encodes for event topics (indexed parameters).
...
<li>
<h5><span class="tsd-kind-parameter">input</span>: <a href="../types/_truffle_codec.Format.Values.Result.html" class="tsd-signature-type tsd-kind-type-alias">Result</a></h5></li></ul></div>
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/topic/encode/index.ts#L14">codec/lib/topic/encode/index.ts:14</a></li></ul></aside></li></ul></section></div>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Topic.Encode"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Topic.Encode.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Encode</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Topic.Encode.encodeTopic.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>encode<wbr/>Topic</span></a></li></ul></div></details></li>
