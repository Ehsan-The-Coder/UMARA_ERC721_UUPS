<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>decodeLiteral | Truffle Decoding and Encoding</title><meta name="description" content="Documentation for Truffle Decoding and Encoding"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="../modules/_truffle_codec.Stack.html">Stack</a></li>
<li><a href="../modules/_truffle_codec.Stack.Decode.html">Decode</a></li>
<li><a href="_truffle_codec.Stack.Decode.decodeLiteral.html">decodeLiteral</a></li></ul>
<h1>Function decodeLiteral</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="decodeLiteral"><span class="tsd-kind-call-signature">decode<wbr/>Literal</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">dataType</span>, <span class="tsd-kind-parameter">pointer</span>, <span class="tsd-kind-parameter">info</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Generator</span><span class="tsd-signature-symbol">&lt;</span><a href="../types/_truffle_codec.DecoderRequest.html" class="tsd-signature-type tsd-kind-type-alias">DecoderRequest</a><span class="tsd-signature-symbol">, </span><a href="../types/_truffle_codec.Format.Values.Result.html" class="tsd-signature-type tsd-kind-type-alias">Result</a><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type ">Uint8Array</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">&gt;</span><a href="#decodeLiteral" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
...
<li>
<h5><span class="tsd-kind-parameter">pointer</span>: <a href="../interfaces/_truffle_codec.Pointer.StackLiteralPointer.html" class="tsd-signature-type tsd-kind-interface">StackLiteralPointer</a></h5></li>
<li>
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/stack/decode/index.ts#L40">codec/lib/stack/decode/index.ts:40</a></li></ul></aside></li></ul></section></div>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Stack"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Stack.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Stack</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li>
<details class="tsd-index-accordion tsd-is-protected" open data-key="@truffle/codec.Stack.Decode"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Stack.Decode.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Decode</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Stack.Decode.decodeLiteral.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>decode<wbr/>Literal</span></a></li>
<li><a href="_truffle_codec.Stack.Decode.decodeStack.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>Stack</span></a></li></ul></div></details></li>
<li><a href="../modules/_truffle_codec.Stack.Read.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Read</span></a></li></ul></div></details></li>
