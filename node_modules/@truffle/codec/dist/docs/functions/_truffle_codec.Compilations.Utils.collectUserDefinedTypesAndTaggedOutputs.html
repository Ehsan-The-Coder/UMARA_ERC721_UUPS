...
<li><a href="../modules/_truffle_codec.Compilations.Utils.html">Utils</a></li>
<li><a href="_truffle_codec.Compilations.Utils.collectUserDefinedTypesAndTaggedOutputs.html">collectUserDefinedTypesAndTaggedOutputs</a></li></ul>
<h1>Function collectUserDefinedTypesAndTaggedOutputs</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="collectUserDefinedTypesAndTaggedOutputs"><span class="tsd-kind-call-signature">collect<wbr/>User<wbr/>Defined<wbr/>Types<wbr/>And<wbr/>Tagged<wbr/>Outputs</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">compilations</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-property">definitions</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span><br/><span>        </span>[<span class="tsd-kind-index-signature">compilationId</span>: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">types</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesById.html" class="tsd-signature-type tsd-kind-interface">TypesById</a><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">typesByCompilation</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesByCompilationAndId.html" class="tsd-signature-type tsd-kind-interface">TypesByCompilationAndId</a><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span><a href="#collectUserDefinedTypesAndTaggedOutputs" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>collects user defined types &amp; tagged outputs for a given set of compilations,
returning both the definition nodes and (for the types) the type objects</p>
<p>&quot;Tagged outputs&quot; means user-defined things that are output by a contract
...
<li>
<h5><span class="tsd-kind-parameter">compilations</span>: <a href="../interfaces/_truffle_codec.Compilations.Compilation.html" class="tsd-signature-type tsd-kind-interface">Compilation</a><span class="tsd-signature-symbol">[]</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-property">definitions</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span><br/><span>        </span>[<span class="tsd-kind-index-signature">compilationId</span>: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">types</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesById.html" class="tsd-signature-type tsd-kind-interface">TypesById</a><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">typesByCompilation</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesByCompilationAndId.html" class="tsd-signature-type tsd-kind-interface">TypesByCompilationAndId</a><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">definitions</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span><br/><span>    </span>[<span class="tsd-kind-index-signature">compilationId</span>: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></h5>
<ul class="tsd-parameters">
...
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">types</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesById.html" class="tsd-signature-type tsd-kind-interface">TypesById</a></h5></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">types<wbr/>By<wbr/>Compilation</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Format.Types.TypesByCompilationAndId.html" class="tsd-signature-type tsd-kind-interface">TypesByCompilationAndId</a></h5></li></ul>
<div class="tsd-comment tsd-typography"></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/compilations/utils.ts#L510">codec/lib/compilations/utils.ts:510</a></li></ul></aside></li></ul></section></div>
...
<ul class="tsd-nested-navigation">
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Compilations.Utils"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Compilations.Utils.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Utils</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Compilations.Utils.collectUserDefinedTypesAndTaggedOutputs.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>collect<wbr/>User<wbr/>Defined<wbr/>Types<wbr/>And<wbr/>Tagged<wbr/>Outputs</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.findCompilationAndContract.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>find<wbr/>Compilation<wbr/>And<wbr/>Contract</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.findRepeatCompilationIds.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>find<wbr/>Repeat<wbr/>Compilation<wbr/>Ids</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.getContractNode.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Contract<wbr/>Node</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.infoToCompilations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>info<wbr/>To<wbr/>Compilations</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.shimArtifacts.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shim<wbr/>Artifacts</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.shimCompilation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shim<wbr/>Compilation</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.shimCompilations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shim<wbr/>Compilations</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.shimContracts.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shim<wbr/>Contracts</span></a></li>
<li><a href="_truffle_codec.Compilations.Utils.simpleShimSourceMap.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>simple<wbr/>Shim<wbr/>Source<wbr/>Map</span></a></li></ul></div></details></li>
<li><a href="../interfaces/_truffle_codec.Compilations.Compilation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-256"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)"></path></g></svg><span>Compilation</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.Contract.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Contract</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.ProjectInfoArtifacts.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Project<wbr/>Info<wbr/>Artifacts</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.ProjectInfoCommon.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Project<wbr/>Info<wbr/>Common</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.ProjectInfoCompilations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Project<wbr/>Info<wbr/>Compilations</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.Source.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Source</span></a></li>
<li><a href="../interfaces/_truffle_codec.Compilations.VyperSourceMap.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Vyper<wbr/>Source<wbr/>Map</span></a></li>
