...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">CalldataAllocations</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/abi-data/allocate/index.ts#L1075">codec/lib/abi-data/allocate/index.ts:1075</a></li></ul></aside></li></ul></section></div>
...
<li><a href="_truffle_codec.AbiData.Allocate.getCalldataAllocations.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Calldata<wbr/>Allocations</span></a></li>
