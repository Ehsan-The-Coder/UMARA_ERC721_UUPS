<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>definitionToStoredType | Truffle Decoding and Encoding</title><meta name="description" content="Documentation for Truffle Decoding and Encoding"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="../modules/_truffle_codec.Ast.Import.html">Import</a></li>
<li><a href="_truffle_codec.Ast.Import.definitionToStoredType.html">definitionToStoredType</a></li></ul>
<h1>Function definitionToStoredType</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="definitionToStoredType"><span class="tsd-kind-call-signature">definition<wbr/>To<wbr/>Stored<wbr/>Type</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">definition</span>, <span class="tsd-kind-parameter">compilationId</span>, <span class="tsd-kind-parameter">compiler</span>, <span class="tsd-kind-parameter">referenceDeclarations</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../types/_truffle_codec.Format.Types.UserDefinedType.html" class="tsd-signature-type tsd-kind-type-alias">UserDefinedType</a><a href="#definitionToStoredType" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
...
<li>
<h5><span class="tsd-kind-parameter">compilationId</span>: <span class="tsd-signature-type">string</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">compiler</span>: <a href="../interfaces/_truffle_codec.Compiler.CompilerVersion.html" class="tsd-signature-type tsd-kind-interface">CompilerVersion</a></h5></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">referenceDeclarations</span>: <a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="../types/_truffle_codec.Format.Types.UserDefinedType.html" class="tsd-signature-type tsd-kind-type-alias">UserDefinedType</a></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/ast/import/index.ts#L387">codec/lib/ast/import/index.ts:387</a></li></ul></aside></li></ul></section></div>
...
<ul class="tsd-nested-navigation">
<li>
<details class="tsd-index-accordion tsd-is-protected" open data-key="@truffle/codec.Ast.Import"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Ast.Import.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Import</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Ast.Import.definitionToStoredType.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>definition<wbr/>To<wbr/>Stored<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Ast.Import.definitionToType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>definition<wbr/>To<wbr/>Type</span></a></li></ul></div></details></li>
