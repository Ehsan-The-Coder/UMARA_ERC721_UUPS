...
<li><a href="../modules/_truffle_codec.Ast.Utils.html">Utils</a></li>
<li><a href="_truffle_codec.Ast.Utils.getterParameters.html">getterParameters</a></li></ul>
<h1>Function getterParameters</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="getterParameters"><span class="tsd-kind-call-signature">getter<wbr/>Parameters</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">node</span>, <span class="tsd-kind-parameter">referenceDeclarations</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-property">inputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">outputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span><a href="#getterParameters" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">node</span>: <a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a></h5></li>
<li>
<h5><span class="tsd-kind-parameter">referenceDeclarations</span>: <a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-property">inputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">outputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">inputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span></h5></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">outputs</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNode.html" class="tsd-signature-type tsd-kind-interface">AstNode</a><span class="tsd-signature-symbol">[]</span></h5></li></ul><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/ast/utils.ts#L831">codec/lib/ast/utils.ts:831</a></li></ul></aside></li></ul></section></div>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Ast.Utils"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="../modules/_truffle_codec.Ast.Utils.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Utils</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Ast.Utils.baseDefinition.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>base<wbr/>Definition</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.contractKind.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>contract<wbr/>Kind</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.decimalPlaces.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decimal<wbr/>Places</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.definitionToAbi.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>definition<wbr/>To<wbr/>Abi</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.functionClass.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>function<wbr/>Class</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.functionKind.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>function<wbr/>Kind</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.getterParameters.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>getter<wbr/>Parameters</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isArray.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Array</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isContractPayable.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Contract<wbr/>Payable</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isDynamicArray.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Dynamic<wbr/>Array</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isEnum.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Enum</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isMapping.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Mapping</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isReference.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Reference</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isSimpleConstant.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Simple<wbr/>Constant</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.isStruct.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Struct</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.keyDefinition.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>key<wbr/>Definition</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.mutability.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>mutability</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.parameters.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>parameters</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.rationalValue.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>rational<wbr/>Value</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.referenceType.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>reference<wbr/>Type</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.regularizeTypeIdentifier.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>regularize<wbr/>Type<wbr/>Identifier</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.specifiedSize.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>specified<wbr/>Size</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.spliceLocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>splice<wbr/>Location</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.stackSize.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>stack<wbr/>Size</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.staticLength.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>static<wbr/>Length</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.staticLengthAsString.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>static<wbr/>Length<wbr/>As<wbr/>String</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeClass.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>Class</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeClassLongForm.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>Class<wbr/>Long<wbr/>Form</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeId.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>Id</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeIdentifier.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>Identifier</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeString.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>String</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.typeStringWithoutLocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>type<wbr/>String<wbr/>Without<wbr/>Location</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.valueDefinition.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>value<wbr/>Definition</span></a></li>
<li><a href="_truffle_codec.Ast.Utils.visibility.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>visibility</span></a></li></ul></div></details></li>
