<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>getEventAllocations | Truffle Decoding and Encoding</title><meta name="description" content="Documentation for Truffle Decoding and Encoding"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="_truffle_codec.AbiData.Allocate.getEventAllocations.html">getEventAllocations</a></li></ul>
<h1>Function getEventAllocations</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="getEventAllocations"><span class="tsd-kind-call-signature">get<wbr/>Event<wbr/>Allocations</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">contracts</span>, <span class="tsd-kind-parameter">referenceDeclarations</span>, <span class="tsd-kind-parameter">userDefinedTypes</span>, <span class="tsd-kind-parameter">abiAllocations</span>, <span class="tsd-kind-parameter">allowConstructorEvents</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">EventAllocations</span><a href="#getEventAllocations" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">contracts</span>: <a href="../interfaces/_truffle_codec.AbiData.Allocate.ContractAllocationInfo.html" class="tsd-signature-type tsd-kind-interface">ContractAllocationInfo</a><span class="tsd-signature-symbol">[]</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">referenceDeclarations</span>: <span class="tsd-signature-symbol">{ </span><br/><span>    </span>[<span class="tsd-kind-index-signature">compilationId</span>: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter-index-signature">
<h5><span class="tsd-signature-symbol">[</span><span class="tsd-kind-parameter">compilationId</span>: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="../interfaces/_truffle_codec.Ast.AstNodes.html" class="tsd-signature-type tsd-kind-interface">AstNodes</a></h5></li></ul></li>
<li>
<h5><span class="tsd-kind-parameter">userDefinedTypes</span>: <a href="../interfaces/_truffle_codec.Format.Types.TypesById.html" class="tsd-signature-type tsd-kind-interface">TypesById</a></h5></li>
<li>
<h5><span class="tsd-kind-parameter">abiAllocations</span>: <a href="../interfaces/_truffle_codec.AbiData.Allocate.AbiAllocations.html" class="tsd-signature-type tsd-kind-interface">AbiAllocations</a></h5></li>
<li>
<h5><span class="tsd-kind-parameter">allowConstructorEvents</span>: <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> = false</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">EventAllocations</span></h4><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/abi-data/allocate/index.ts#L1419">codec/lib/abi-data/allocate/index.ts:1419</a></li></ul></aside></li></ul></section></div>
...
<li><a href="_truffle_codec.AbiData.Allocate.abiSizeInfo-1.html" class="tsd-is-protected"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>abi<wbr/>Size<wbr/>Info</span></a></li>
<li><a href="_truffle_codec.AbiData.Allocate.getAbiAllocations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Abi<wbr/>Allocations</span></a></li>
<li><a href="_truffle_codec.AbiData.Allocate.getCalldataAllocations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Calldata<wbr/>Allocations</span></a></li>
<li><a href="_truffle_codec.AbiData.Allocate.getEventAllocations.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Event<wbr/>Allocations</span></a></li>
<li><a href="_truffle_codec.AbiData.Allocate.getReturndataAllocations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Returndata<wbr/>Allocations</span></a></li></ul></div></details></li>
