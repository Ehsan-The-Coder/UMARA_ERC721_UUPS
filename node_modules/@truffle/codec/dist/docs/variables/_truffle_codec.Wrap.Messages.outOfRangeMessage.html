...
<li><a href="_truffle_codec.Wrap.Messages.outOfRangeMessage.html">outOfRangeMessage</a></li></ul>
<h1>Variable outOfRangeMessage<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">out<wbr/>Of<wbr/>Range<wbr/>Message</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> = &quot;Input is outside the range of this numeric type&quot;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/messages.ts#L21">codec/lib/wrap/messages.ts:21</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Wrap.Messages.outOfRangeMessage.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>out<wbr/>Of<wbr/>Range<wbr/>Message</span></a></li>
