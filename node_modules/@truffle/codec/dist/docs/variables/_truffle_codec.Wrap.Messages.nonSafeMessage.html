...
<li><a href="_truffle_codec.Wrap.Messages.nonSafeMessage.html">nonSafeMessage</a></li></ul>
<h1>Variable nonSafeMessage<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">non<wbr/>Safe<wbr/>Message</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> = &quot;Input number is not a Javascript safe integer&quot;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/messages.ts#L18">codec/lib/wrap/messages.ts:18</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Wrap.Messages.nonSafeMessage.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Safe<wbr/>Message</span></a></li>
