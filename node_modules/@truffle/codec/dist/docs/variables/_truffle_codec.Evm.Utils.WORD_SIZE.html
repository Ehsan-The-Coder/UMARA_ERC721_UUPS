...
<li><a href="_truffle_codec.Evm.Utils.WORD_SIZE.html">WORD_SIZE</a></li></ul>
<h1>Variable WORD_SIZE<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">WORD_<wbr/>SIZE</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">32</span><span class="tsd-signature-symbol"> = 0x20</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/evm/utils.ts#L9">codec/lib/evm/utils.ts:9</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Evm.Utils.WORD_SIZE.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>WORD_<wbr/>SIZE</span></a></li>
