<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>notAStringMessage | Truffle Decoding and Encoding</title><meta name="description" content="Documentation for Truffle Decoding and Encoding"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="_truffle_codec.Wrap.Messages.notAStringMessage.html">notAStringMessage</a></li></ul>
<h1>Variable notAStringMessage<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">notAString<wbr/>Message</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> = &quot;Input was not a string, type/value pair, or wrapped or boxed string&quot;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/messages.ts#L14">codec/lib/wrap/messages.ts:14</a></li></ul></aside></div>
...
<li><a href="_truffle_codec.Wrap.Messages.notAStringMessage.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>notAString<wbr/>Message</span></a></li>
