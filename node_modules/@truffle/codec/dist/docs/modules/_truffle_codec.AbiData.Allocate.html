...
<li><a href="_truffle_codec.AbiData.html">AbiData</a></li>
<li><a href="_truffle_codec.AbiData.Allocate.html">Allocate</a></li></ul>
<h1>Namespace Allocate</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/abi-data/allocate/index.ts#L1">codec/lib/abi-data/allocate/index.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Namespaces</h3>
<div class="tsd-index-list"><a href="_truffle_codec.AbiData.Allocate.Utils.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-4"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-namespace)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.33 16V7.24H10.77L13.446 14.74C13.43 14.54 13.41 14.296 13.386 14.008C13.37 13.712 13.354 13.404 13.338 13.084C13.33 12.756 13.326 12.448 13.326 12.16V7.24H14.37V16H12.93L10.266 8.5C10.282 8.692 10.298 8.936 10.314 9.232C10.33 9.52 10.342 9.828 10.35 10.156C10.366 10.476 10.374 10.784 10.374 11.08V16H9.33Z" fill="var(--color-text)"></path></g></svg><span>Utils</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Interfaces</h3>
<div class="tsd-index-list"><a href="../interfaces/_truffle_codec.AbiData.Allocate.AbiAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-256"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)"></path></g></svg><span>Abi<wbr/>Allocations</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.AbiSizeInfo.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Abi<wbr/>Size<wbr/>Info</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.BlankReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Blank<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.CalldataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Calldata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.ConstructorReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Constructor<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.ContractAllocationInfo.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Contract<wbr/>Allocation<wbr/>Info</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.ContractAndContexts.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Contract<wbr/>And<wbr/>Contexts</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.EventAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Event<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.FunctionCalldataAndReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Function<wbr/>Calldata<wbr/>And<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.MessageReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Message<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.ReturnValueReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Return<wbr/>Value<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.ReturndataAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Returndata<wbr/>Allocations</span></a>
<a href="../interfaces/_truffle_codec.AbiData.Allocate.RevertReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Revert<wbr/>Returndata<wbr/>Allocation</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Type Aliases</h3>
<div class="tsd-index-list"><a href="../types/_truffle_codec.AbiData.Allocate.CalldataAndReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-4194304"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-type-alias)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.31 16V8.224H8.91V7.24H14.79V8.224H12.39V16H11.31Z" fill="var(--color-text)"></path></g></svg><span>Calldata<wbr/>And<wbr/>Returndata<wbr/>Allocation</span></a>
<a href="../types/_truffle_codec.AbiData.Allocate.ReturndataAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Returndata<wbr/>Allocation</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Variables</h3>
<div class="tsd-index-list"><a href="../variables/_truffle_codec.AbiData.Allocate.FallbackOutputAllocation.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-32"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-variable)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.106 16L8.85 7.24H9.966L11.454 13.192C11.558 13.608 11.646 13.996 11.718 14.356C11.79 14.708 11.842 14.976 11.874 15.16C11.906 14.976 11.954 14.708 12.018 14.356C12.09 13.996 12.178 13.608 12.282 13.192L13.758 7.24H14.85L12.582 16H11.106Z" fill="var(--color-text)"></path></g></svg><span>Fallback<wbr/>Output<wbr/>Allocation</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.AbiData.Allocate.abiSizeInfo-1.html" class="tsd-index-link tsd-is-protected"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>abi<wbr/>Size<wbr/>Info</span></a>
<a href="../functions/_truffle_codec.AbiData.Allocate.getAbiAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Abi<wbr/>Allocations</span></a>
<a href="../functions/_truffle_codec.AbiData.Allocate.getCalldataAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Calldata<wbr/>Allocations</span></a>
<a href="../functions/_truffle_codec.AbiData.Allocate.getEventAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Event<wbr/>Allocations</span></a>
<a href="../functions/_truffle_codec.AbiData.Allocate.getReturndataAllocations.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>get<wbr/>Returndata<wbr/>Allocations</span></a>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.AbiData"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.AbiData.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Abi<wbr/>Data</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.AbiData.Allocate"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.AbiData.Allocate.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Allocate</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.AbiData.Allocate.Utils.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Utils</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.AbiAllocations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Abi<wbr/>Allocations</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.AbiSizeInfo.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Abi<wbr/>Size<wbr/>Info</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.BlankReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Blank<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.CalldataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Calldata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.ConstructorReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Constructor<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.ContractAllocationInfo.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Contract<wbr/>Allocation<wbr/>Info</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.ContractAndContexts.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Contract<wbr/>And<wbr/>Contexts</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.EventAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Event<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.FunctionCalldataAndReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Function<wbr/>Calldata<wbr/>And<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.MessageReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Message<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.ReturnValueReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Return<wbr/>Value<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.ReturndataAllocations.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Returndata<wbr/>Allocations</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.Allocate.RevertReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Revert<wbr/>Returndata<wbr/>Allocation</span></a></li>
<li><a href="../types/_truffle_codec.AbiData.Allocate.CalldataAndReturndataAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Calldata<wbr/>And<wbr/>Returndata<wbr/>Allocation</span></a></li>
...
<li><a href="../variables/_truffle_codec.AbiData.Allocate.FallbackOutputAllocation.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>Fallback<wbr/>Output<wbr/>Allocation</span></a></li>
...
<li><a href="_truffle_codec.AbiData.Decode.html" class="tsd-is-protected"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Decode</span></a></li>
<li><a href="_truffle_codec.AbiData.Encode.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Encode</span></a></li>
<li><a href="_truffle_codec.AbiData.Import.html" class="tsd-is-protected"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Import</span></a></li>
<li><a href="_truffle_codec.AbiData.Utils.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Utils</span></a></li>
<li><a href="../interfaces/_truffle_codec.AbiData.FunctionAbiBySelectors.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Function<wbr/>Abi<wbr/>By<wbr/>Selectors</span></a></li></ul></div></details></li>
