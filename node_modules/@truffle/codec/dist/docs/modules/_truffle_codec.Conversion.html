...
<li><a href="_truffle_codec.Conversion.html">Conversion</a></li></ul>
<h1>Namespace Conversion</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/conversion.ts#L1">codec/lib/conversion.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.Conversion.cleanBool.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>clean<wbr/>Bool</span></a>
<a href="../functions/_truffle_codec.Conversion.countDecimalPlaces.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>count<wbr/>Decimal<wbr/>Places</span></a>
<a href="../functions/_truffle_codec.Conversion.isBig.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Big</span></a>
<a href="../functions/_truffle_codec.Conversion.shiftBigDown.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shift<wbr/>Big<wbr/>Down</span></a>
<a href="../functions/_truffle_codec.Conversion.shiftBigUp.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shift<wbr/>Big<wbr/>Up</span></a>
<a href="../functions/_truffle_codec.Conversion.stringToBytes.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>string<wbr/>To<wbr/>Bytes</span></a>
<a href="../functions/_truffle_codec.Conversion.toBN.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>toBN</span></a>
<a href="../functions/_truffle_codec.Conversion.toBig.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Big</span></a>
<a href="../functions/_truffle_codec.Conversion.toBigInt.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Big<wbr/>Int</span></a>
<a href="../functions/_truffle_codec.Conversion.toBytes.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Bytes</span></a>
<a href="../functions/_truffle_codec.Conversion.toHexString.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Hex<wbr/>String</span></a>
<a href="../functions/_truffle_codec.Conversion.toSignedBN.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>SignedBN</span></a>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Conversion"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Conversion.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Conversion</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="../functions/_truffle_codec.Conversion.cleanBool.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>clean<wbr/>Bool</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.countDecimalPlaces.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>count<wbr/>Decimal<wbr/>Places</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.isBig.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>is<wbr/>Big</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.shiftBigDown.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shift<wbr/>Big<wbr/>Down</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.shiftBigUp.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>shift<wbr/>Big<wbr/>Up</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.stringToBytes.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>string<wbr/>To<wbr/>Bytes</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toBN.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>toBN</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toBig.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Big</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toBigInt.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Big<wbr/>Int</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toBytes.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Bytes</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toHexString.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>Hex<wbr/>String</span></a></li>
<li><a href="../functions/_truffle_codec.Conversion.toSignedBN.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>to<wbr/>SignedBN</span></a></li></ul></div></details></li>
