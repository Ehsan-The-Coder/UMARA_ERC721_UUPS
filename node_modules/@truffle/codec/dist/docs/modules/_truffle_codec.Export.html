...
<li><a href="_truffle_codec.Export.html">Export</a></li></ul>
<h1>Namespace Export</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/export.ts#L1">codec/lib/export.ts:1</a></li></ul></aside>
...
<div class="tsd-index-list"><a href="_truffle_codec.Export.html#ResultInspector" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-8388608"><rect fill="var(--color-icon-background)" stroke="#FF4D82" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M10.354 17V8.24H13.066C13.586 8.24 14.042 8.348 14.434 8.564C14.826 8.772 15.13 9.064 15.346 9.44C15.562 9.816 15.67 10.256 15.67 10.76C15.67 11.352 15.514 11.86 15.202 12.284C14.898 12.708 14.482 13 13.954 13.16L15.79 17H14.518L12.838 13.28H11.434V17H10.354ZM11.434 12.308H13.066C13.514 12.308 13.874 12.168 14.146 11.888C14.418 11.6 14.554 11.224 14.554 10.76C14.554 10.288 14.418 9.912 14.146 9.632C13.874 9.352 13.514 9.212 13.066 9.212H11.434V12.308Z" fill="var(--color-text)"></path></g></svg><span>Result<wbr/>Inspector</span></a>
<a href="_truffle_codec.Export.html#ResultInspectorOptions" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>Result<wbr/>Inspector<wbr/>Options</span></a>
<a href="_truffle_codec.Export.html#nativizeAccessList" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>nativize<wbr/>Access<wbr/>List</span></a>
<a href="_truffle_codec.Export.html#stringValueInfoToStringLossy" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>string<wbr/>Value<wbr/>Info<wbr/>To<wbr/>String<wbr/>Lossy</span></a>
<a href="_truffle_codec.Export.html#unsafeNativize" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize</span></a>
<a href="_truffle_codec.Export.html#unsafeNativizeVariables" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize<wbr/>Variables</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Classes</h3>
<div class="tsd-index-list"><a href="../classes/_truffle_codec.Export.CalldataDecodingInspector.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-128"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-class)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)"></path></g></svg><span>Calldata<wbr/>Decoding<wbr/>Inspector</span></a>
<a href="../classes/_truffle_codec.Export.LogDecodingInspector.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Log<wbr/>Decoding<wbr/>Inspector</span></a>
<a href="../classes/_truffle_codec.Export.ReturndataDecodingInspector.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Returndata<wbr/>Decoding<wbr/>Inspector</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Interfaces</h3>
<div class="tsd-index-list"><a href="../interfaces/_truffle_codec.Export.NativizeOptions.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-256"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)"></path></g></svg><span>Nativize<wbr/>Options</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.Export.containsDeliberateReadError.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>contains<wbr/>Deliberate<wbr/>Read<wbr/>Error</span></a>
<a href="../functions/_truffle_codec.Export.nativize.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>nativize</span></a>
<a href="../functions/_truffle_codec.Export.nativizeEventArgs.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>nativize<wbr/>Event<wbr/>Args</span></a>
<a href="../functions/_truffle_codec.Export.nativizeReturn.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>nativize<wbr/>Return</span></a>
</div></section></div></details></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>References</h2>
<section class="tsd-panel tsd-member"><a id="ResultInspector" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>Result<wbr/>Inspector</span><a href="#ResultInspector" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></h3>Re-exports <a href="../classes/_truffle_codec.Format.Utils.Inspect.ResultInspector.html">ResultInspector</a></section>
<section class="tsd-panel tsd-member"><a id="ResultInspectorOptions" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>Result<wbr/>Inspector<wbr/>Options</span><a href="#ResultInspectorOptions" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>Re-exports <a href="../interfaces/_truffle_codec.Format.Utils.Inspect.ResultInspectorOptions.html">ResultInspectorOptions</a></section>
<section class="tsd-panel tsd-member"><a id="nativizeAccessList" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>nativize<wbr/>Access<wbr/>List</span><a href="#nativizeAccessList" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>Re-exports <a href="../functions/_truffle_codec.Format.Utils.Inspect.nativizeAccessList.html">nativizeAccessList</a></section>
<section class="tsd-panel tsd-member"><a id="stringValueInfoToStringLossy" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>string<wbr/>Value<wbr/>Info<wbr/>To<wbr/>String<wbr/>Lossy</span><a href="#stringValueInfoToStringLossy" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>Re-exports <a href="../functions/_truffle_codec.Format.Utils.Inspect.stringValueInfoToStringLossy.html">stringValueInfoToStringLossy</a></section>
<section class="tsd-panel tsd-member"><a id="unsafeNativize" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>unsafe<wbr/>Nativize</span><a href="#unsafeNativize" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>Re-exports <a href="../functions/_truffle_codec.Format.Utils.Inspect.unsafeNativize.html">unsafeNativize</a></section>
<section class="tsd-panel tsd-member"><a id="unsafeNativizeVariables" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>unsafe<wbr/>Nativize<wbr/>Variables</span><a href="#unsafeNativizeVariables" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>Re-exports <a href="../functions/_truffle_codec.Format.Utils.Inspect.unsafeNativizeVariables.html">unsafeNativizeVariables</a></section></section></div>
...
<div class="tsd-accordion-details">
<ul>
<li><a href="#ResultInspector" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>Result<wbr/>Inspector</span></a></li>
<li><a href="#ResultInspectorOptions" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>Result<wbr/>Inspector<wbr/>Options</span></a></li>
<li><a href="#nativizeAccessList" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>nativize<wbr/>Access<wbr/>List</span></a></li>
<li><a href="#stringValueInfoToStringLossy" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>string<wbr/>Value<wbr/>Info<wbr/>To<wbr/>String<wbr/>Lossy</span></a></li>
<li><a href="#unsafeNativize" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize</span></a></li>
<li><a href="#unsafeNativizeVariables" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize<wbr/>Variables</span></a></li></ul></div></details></div>
<div class="site-menu">
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Export"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Export.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Export</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Export.html#ResultInspector"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>Result<wbr/>Inspector</span></a></li>
<li><a href="_truffle_codec.Export.html#ResultInspectorOptions"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>Result<wbr/>Inspector<wbr/>Options</span></a></li>
<li><a href="_truffle_codec.Export.html#nativizeAccessList"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>nativize<wbr/>Access<wbr/>List</span></a></li>
<li><a href="_truffle_codec.Export.html#stringValueInfoToStringLossy"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>string<wbr/>Value<wbr/>Info<wbr/>To<wbr/>String<wbr/>Lossy</span></a></li>
<li><a href="_truffle_codec.Export.html#unsafeNativize"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize</span></a></li>
<li><a href="_truffle_codec.Export.html#unsafeNativizeVariables"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-8388608"></use></svg><span>unsafe<wbr/>Nativize<wbr/>Variables</span></a></li>
<li><a href="../classes/_truffle_codec.Export.CalldataDecodingInspector.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Calldata<wbr/>Decoding<wbr/>Inspector</span></a></li>
...
<li><a href="../interfaces/_truffle_codec.Export.NativizeOptions.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Nativize<wbr/>Options</span></a></li>
<li><a href="../functions/_truffle_codec.Export.containsDeliberateReadError.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>contains<wbr/>Deliberate<wbr/>Read<wbr/>Error</span></a></li>
