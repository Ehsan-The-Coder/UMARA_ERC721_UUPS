...
<li><a href="_truffle_codec.Basic.html">Basic</a></li>
<li><a href="_truffle_codec.Basic.Decode.html">Decode</a></li></ul>
<h1>Namespace Decode</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/basic/decode/index.ts#L1">codec/lib/basic/decode/index.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.Basic.Decode.checkPaddingLeft.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>check<wbr/>Padding<wbr/>Left</span></a>
<a href="../functions/_truffle_codec.Basic.Decode.decodeBasic.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>Basic</span></a>
<a href="../functions/_truffle_codec.Basic.Decode.decodeContract.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>Contract</span></a>
<a href="../functions/_truffle_codec.Basic.Decode.decodeExternalFunction.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>External<wbr/>Function</span></a>
...
<li>
<details class="tsd-index-accordion tsd-is-protected" open data-key="@truffle/codec.Basic"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Basic.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Basic</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.Basic.Allocate.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Allocate</span></a></li>
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Basic.Decode"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Basic.Decode.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Decode</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="../functions/_truffle_codec.Basic.Decode.checkPaddingLeft.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>check<wbr/>Padding<wbr/>Left</span></a></li>
<li><a href="../functions/_truffle_codec.Basic.Decode.decodeBasic.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>Basic</span></a></li>
<li><a href="../functions/_truffle_codec.Basic.Decode.decodeContract.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>Contract</span></a></li>
<li><a href="../functions/_truffle_codec.Basic.Decode.decodeExternalFunction.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>decode<wbr/>External<wbr/>Function</span></a></li></ul></div></details></li>
<li><a href="_truffle_codec.Basic.Encode.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Encode</span></a></li></ul></div></details></li>
