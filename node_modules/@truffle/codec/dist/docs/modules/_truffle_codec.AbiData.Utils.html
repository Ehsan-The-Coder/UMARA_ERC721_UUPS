...
<li><a href="_truffle_codec.AbiData.Utils.html">Utils</a></li></ul>
<h1>Namespace Utils</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/abi-data/utils.ts#L1">codec/lib/abi-data/utils.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Variables</h3>
<div class="tsd-index-list"><a href="../variables/_truffle_codec.AbiData.Utils.DEFAULT_CONSTRUCTOR_ABI.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-32"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-variable)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.106 16L8.85 7.24H9.966L11.454 13.192C11.558 13.608 11.646 13.996 11.718 14.356C11.79 14.708 11.842 14.976 11.874 15.16C11.906 14.976 11.954 14.708 12.018 14.356C12.09 13.996 12.178 13.608 12.282 13.192L13.758 7.24H14.85L12.582 16H11.106Z" fill="var(--color-text)"></path></g></svg><span>DEFAULT_<wbr/>CONSTRUCTOR_<wbr/>ABI</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.AbiData.Utils.abiEntryHasStorageParameters.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>abi<wbr/>Entry<wbr/>Has<wbr/>Storage<wbr/>Parameters</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiEntryIsObviouslyIllTyped.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Entry<wbr/>Is<wbr/>Obviously<wbr/>Ill<wbr/>Typed</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiHasPayableFallback.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Has<wbr/>Payable<wbr/>Fallback</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiSelector.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Selector</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiSignature.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Signature</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiTupleSignature.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Tuple<wbr/>Signature</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abiTypeSignature.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Type<wbr/>Signature</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.abisMatch.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abis<wbr/>Match</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.computeSelectors.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>compute<wbr/>Selectors</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.definitionMatchesAbi.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>definition<wbr/>Matches<wbr/>Abi</span></a>
<a href="../functions/_truffle_codec.AbiData.Utils.topicsCount.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>topics<wbr/>Count</span></a>
...
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="_truffle_codec.AbiData.Allocate.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Allocate</span></a></li>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.AbiData.Utils"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.AbiData.Utils.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Utils</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="../variables/_truffle_codec.AbiData.Utils.DEFAULT_CONSTRUCTOR_ABI.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>DEFAULT_<wbr/>CONSTRUCTOR_<wbr/>ABI</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiEntryHasStorageParameters.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Entry<wbr/>Has<wbr/>Storage<wbr/>Parameters</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiEntryIsObviouslyIllTyped.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Entry<wbr/>Is<wbr/>Obviously<wbr/>Ill<wbr/>Typed</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiHasPayableFallback.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Has<wbr/>Payable<wbr/>Fallback</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiSelector.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Selector</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiSignature.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Signature</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiTupleSignature.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Tuple<wbr/>Signature</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abiTypeSignature.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abi<wbr/>Type<wbr/>Signature</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.abisMatch.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>abis<wbr/>Match</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.computeSelectors.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>compute<wbr/>Selectors</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.definitionMatchesAbi.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>definition<wbr/>Matches<wbr/>Abi</span></a></li>
<li><a href="../functions/_truffle_codec.AbiData.Utils.topicsCount.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>topics<wbr/>Count</span></a></li></ul></div></details></li>
