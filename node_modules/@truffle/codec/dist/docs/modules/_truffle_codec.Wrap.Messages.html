...
<li><a href="_truffle_codec.Wrap.html">Wrap</a></li>
<li><a href="_truffle_codec.Wrap.Messages.html">Messages</a></li></ul>
<h1>Namespace Messages</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/wrap/messages.ts#L1">codec/lib/wrap/messages.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Variables</h3>
<div class="tsd-index-list"><a href="../variables/_truffle_codec.Wrap.Messages.badEnumMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-32"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-variable)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.106 16L8.85 7.24H9.966L11.454 13.192C11.558 13.608 11.646 13.996 11.718 14.356C11.79 14.708 11.842 14.976 11.874 15.16C11.906 14.976 11.954 14.708 12.018 14.356C12.09 13.996 12.178 13.608 12.282 13.192L13.758 7.24H14.85L12.582 16H11.106Z" fill="var(--color-text)"></path></g></svg><span>bad<wbr/>Enum<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.checksumFailedMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>checksum<wbr/>Failed<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.errorResultMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>error<wbr/>Result<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.invalidUtf16Message.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>invalid<wbr/>Utf16<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.looseModeOnlyMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>loose<wbr/>Mode<wbr/>Only<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.negativeBytesMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>negative<wbr/>Bytes<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.nonIntegerMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Integer<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.nonNumericMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Numeric<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.nonSafeMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Safe<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.notAStringMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>notAString<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.outOfRangeEnumMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>out<wbr/>Of<wbr/>Range<wbr/>Enum<wbr/>Message</span></a>
<a href="../variables/_truffle_codec.Wrap.Messages.outOfRangeMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>out<wbr/>Of<wbr/>Range<wbr/>Message</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Functions</h3>
<div class="tsd-index-list"><a href="../functions/_truffle_codec.Wrap.Messages.notABytestringMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-64"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-function)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.39 16V7.24H14.55V8.224H10.446V11.128H14.238V12.112H10.47V16H9.39Z" fill="var(--color-text)"></path></g></svg><span>notABytestring<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.overlongMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>overlong<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.specifiedTypeMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>specified<wbr/>Type<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.tooPreciseMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>too<wbr/>Precise<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.unrecognizedNumberMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>unrecognized<wbr/>Number<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.wrappedTypeMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>wrapped<wbr/>Type<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.wrongArrayLengthMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>wrong<wbr/>Array<wbr/>Length<wbr/>Message</span></a>
<a href="../functions/_truffle_codec.Wrap.Messages.wrongLengthMessage.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>wrong<wbr/>Length<wbr/>Message</span></a>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Wrap"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Wrap.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Wrap</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Wrap.Messages"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Wrap.Messages.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Messages</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="../variables/_truffle_codec.Wrap.Messages.badEnumMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>bad<wbr/>Enum<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.checksumFailedMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>checksum<wbr/>Failed<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.errorResultMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>error<wbr/>Result<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.invalidUtf16Message.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>invalid<wbr/>Utf16<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.looseModeOnlyMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>loose<wbr/>Mode<wbr/>Only<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.negativeBytesMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>negative<wbr/>Bytes<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.nonIntegerMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Integer<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.nonNumericMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Numeric<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.nonSafeMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>non<wbr/>Safe<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.notAStringMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>notAString<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.outOfRangeEnumMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>out<wbr/>Of<wbr/>Range<wbr/>Enum<wbr/>Message</span></a></li>
<li><a href="../variables/_truffle_codec.Wrap.Messages.outOfRangeMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-32"></use></svg><span>out<wbr/>Of<wbr/>Range<wbr/>Message</span></a></li>
<li><a href="../functions/_truffle_codec.Wrap.Messages.notABytestringMessage.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>notABytestring<wbr/>Message</span></a></li>
