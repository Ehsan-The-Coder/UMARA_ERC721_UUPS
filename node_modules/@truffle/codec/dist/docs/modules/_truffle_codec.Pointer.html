...
<li><a href="_truffle_codec.Pointer.html">Pointer</a></li></ul>
<h1>Namespace Pointer</h1></div><aside class="tsd-sources">
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/854a564b2/packages/codec/lib/pointer/index.ts#L1">codec/lib/pointer/index.ts:1</a></li></ul></aside>
<section class="tsd-panel-group tsd-index-group">
<section class="tsd-panel tsd-index-panel">
<h3 class="tsd-index-heading uppercase">Index</h3>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Interfaces</h3>
<div class="tsd-index-list"><a href="../interfaces/_truffle_codec.Pointer.CalldataPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-256"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)"></path></g></svg><span>Calldata<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.CodePointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Code<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.ConstantDefinitionPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Constant<wbr/>Definition<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.EventDataPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Event<wbr/>Data<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.EventTopicPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Event<wbr/>Topic<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.GenericAbiPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Generic<wbr/>Abi<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.MemoryPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Memory<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.ReturndataPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Returndata<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.SpecialPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Special<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.StackLiteralPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Stack<wbr/>Literal<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.StackPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Stack<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.StoragePointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Storage<wbr/>Pointer</span></a>
<a href="../interfaces/_truffle_codec.Pointer.UnreadablePointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Unreadable<wbr/>Pointer</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Type Aliases</h3>
<div class="tsd-index-list"><a href="../types/_truffle_codec.Pointer.AbiDataPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-4194304"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-type-alias)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6"></rect><path d="M11.31 16V8.224H8.91V7.24H14.79V8.224H12.39V16H11.31Z" fill="var(--color-text)"></path></g></svg><span>Abi<wbr/>Data<wbr/>Pointer</span></a>
<a href="../types/_truffle_codec.Pointer.AbiPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Abi<wbr/>Pointer</span></a>
<a href="../types/_truffle_codec.Pointer.BytesPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Bytes<wbr/>Pointer</span></a>
<a href="../types/_truffle_codec.Pointer.CodeFormPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Code<wbr/>Form<wbr/>Pointer</span></a>
<a href="../types/_truffle_codec.Pointer.DataPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Data<wbr/>Pointer</span></a>
<a href="../types/_truffle_codec.Pointer.StackFormPointer.html" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Stack<wbr/>Form<wbr/>Pointer</span></a>
...
<li>
<details class="tsd-index-accordion" open data-key="@truffle/codec.Pointer"><summary class="tsd-accordion-summary"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg><a href="_truffle_codec.Pointer.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4"></use></svg><span>Pointer</span></a></summary>
<div class="tsd-accordion-details">
<ul class="tsd-nested-navigation">
<li><a href="../interfaces/_truffle_codec.Pointer.CalldataPointer.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Calldata<wbr/>Pointer</span></a></li>
...
<li><a href="../types/_truffle_codec.Pointer.AbiDataPointer.html"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Abi<wbr/>Data<wbr/>Pointer</span></a></li>
